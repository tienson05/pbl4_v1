/****************************************************************************
** Meta object code from reading C++ file 'CaptureEngine.hpp'
**
...
#include "../../../../../../../src/Core/Capture/CaptureEngine.hpp"
...
#error "The header file 'CaptureEngine.hpp' doesn't include <QObject>."
...
template <> constexpr inline auto CaptureEngine::qt_create_metaobjectdata<qt_meta_tag_ZN13CaptureEngineE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const PacketData &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
...
void CaptureEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CaptureEngine::*)(const PacketData & )>(_a, &CaptureEngine::packetCaptured, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (CaptureEngine::*)(const QString & )>(_a, &CaptureEngine::errorOccurred, 1))
            return;
    }
}
...
// SIGNAL 0
void CaptureEngine::packetCaptured(const PacketData & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void CaptureEngine::errorOccurred(const QString & _t1)
{
